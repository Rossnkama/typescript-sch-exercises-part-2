...
describe('Unchecked Returns Exercise 3', function () {
    ...
    before(async function () {
        ...
        expect(this.stableSwap.swap(this.usdc.address, this.dai.address, amount)).to.not.be.reverted;
        ...
        expect(this.stableSwap.swap(this.usdc.address, this.dai.address, amount)).to.be.reverted;
