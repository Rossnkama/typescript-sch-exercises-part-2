...
import fs from "fs";
import { DummyERC20, DummyERC20__factory, IWETH9 } from "../../typechain-types";
...
describe("DEFI Money Markets: DEX Exercise 2 - Sniper", function () {
    ...
    const UNISWAPV2_FACTORY_ADDRESS =
        "0x5c69bee701ef814a2b6a3edd4b1652cb9cc5aa6f";
    const UNISWAPV2_ROUTER_ADDRESS =
        "0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D";
    const UNISWAPV2_ROUTER_ABI = fs
        .readFileSync("./test/dex-2/router.json")
        .toString();
    ...
    before(async function () {
        ...
        const dummyTokenFactory = (await ethers.getContractFactory(
            ...
            liquidityAdder
        )) as DummyERC20__factory;
        preciousToken = await dummyTokenFactory.deploy(
            "PreciousToken",
            "PRECIOUS",
            INITIAL_MINT
        );
